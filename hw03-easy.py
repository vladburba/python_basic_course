...
print('Строка максимальной длины = ',func('Ivan', '10fgfg', '1sdsdg', '2sdfsdf', '3', '5', '4','sdgsdgdgывпы',
                                         'ыфвафывафывафывафываывава', 'sdgasdgasdgfasdgasdgasdgasdgasdgas'))
print('Task_3_finished')